...
class SVM:
    def __init__(self, C, gamma_0, a, max_epochs):
        """
        ...
        Args:
            ...
            a (float): Learning rate decay factor.
    ...
    def _learning_rate(self, t):
        """Calculates the decayed learning rate at iteration t."""
    ...
    def fit(self, X, y):
        ...
        for epoch in range(self.max_epochs):
            ...
            for t, i in enumerate(indices):
                lr = self._learning_rate(epoch * n_samples + t)
...
def main():
    ...
    for C in Cs:
        ...
        model = SVM(C, gamma_0, a, max_epochs)
